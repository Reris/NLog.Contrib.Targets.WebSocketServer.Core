...
namespace NLog.Contrib.Targets.WebSocket.Web.AspNetCore
{
    public abstract class WebSocketConnection
    {
        ...
        internal async Task AcceptSocketAsync(HttpContext context, IDictionary<string, string> argumentMatches)
        {
            Context = context;
        ...
        private async Task RunWebSocket(System.Net.WebSockets.WebSocket webSocket)
        {
            mWebSocket = new NetWebSocket(webSocket);
