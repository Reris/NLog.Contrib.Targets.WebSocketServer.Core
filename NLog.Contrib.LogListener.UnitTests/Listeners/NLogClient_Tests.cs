...
public class NLogClient_Tests
{
    ...
    private readonly TcpListenerOptions _options = new();
    ...
    public void ChannelDataReceived_DeserializerTryExtractSucceeded_ShouldSetCurrentDataToLeftover(string expected)
    {
        ...
        this._deserializer.TryExtract(new ExtractInput("Foo", new DeserializerOptions())).Returns(new ExtractResult(true, null, expected));
    ...
    public void ChannelDataReceived_DeserializerTryExtractSucceed_ShouldCallClientLogWithResult()
    {
        ...
        this._deserializer.TryExtract(new ExtractInput("Foo", new DeserializerOptions())).Returns(new ExtractResult(true, expectedLog, ""));
    ...
    public void ChannelDataReceived_DeserializerTryExtractSucceedMultipleTimes_ShouldCallClientLogWithResult()
    {
        ...
        this._deserializer.TryExtract(new ExtractInput("Foo1Foo2", new DeserializerOptions())).Returns(new ExtractResult(true, expectedLog1, "Foo2"));
        this._deserializer.TryExtract(new ExtractInput("Foo2", new DeserializerOptions())).Returns(new ExtractResult(true, expectedLog2, ""));
