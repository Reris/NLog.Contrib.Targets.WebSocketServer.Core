...
public class ExtractInput
{
    ...
    public ExtractInput(string data, DeserializerOptions options)
        : this(Encoding.UTF8.GetBytes(data), options)
    {
        this._dataString = data;
    }

    public ExtractInput(ReadOnlyMemory<byte> data, DeserializerOptions options)
    {
        this.Data = data;
    ...
    public DeserializerOptions Options { get; }
