...
namespace NLog.Contrib.LogListener.Tcp.UnitTests.Deserializers;
...
public class NLogDeserializer_Tests
{
    ...
    {
        this._deserializers = new IFormatDeserializer[] { new JsonFormatDeserializer(), new Log4JFormatDeserializer() };
    }
    ...
    [InlineData(
        ...
        NLogLevel.Info,
        "App=Unknown.Machine=Unknown.Foo",
        "Bar",
        "")]
    [InlineData(
        """
        ...
        """,
        NLogLevel.Info,
        "App=Company:MyApp.Machine=97d38438edf9.Foo",
        "Bar",
        "")]
    [InlineData(
    ...
    public void TryExtract_CompleteLog4J_ShouldExtract(string data, NLogLevel level, string logger, string message, string leftover)
    {
        ...
        // Act
        var result = testee.TryExtract(new ExtractInput(data), false);
    ...
    [InlineData(
        ...
        "")]
    [InlineData(
        """{"logger":"Foo","level":"INFO","message":"Bar","properties":{"app":"Company.MyApp","machinename":"97d38438edf9"}}""",
        NLogLevel.Info,
        "App=Company:MyApp.Machine=97d38438edf9.Foo",
        "Bar",
        "")]
    ...
    public void TryExtract_InvalidLog4J_ShouldCutInvalidData(string data, string leftover)
    {
        ...
        // Act
        var result = testee.TryExtract(new ExtractInput(data));
    ...
    [Fact]
    public void Convert__ShouldReturnContent()
    {
        // Arrange
        var testee = this.CreateTestee();
        var message = new NLogMessage
        {
        ...
        // Act
        var result = testee.Convert(message);

        // Assert
        result.Level.Should().BeSameAs(LogLevel.Info);
        result.LoggerName.Should().Be(message.Logger);
    ...
    public void TryExtract_InputEmpty_ShouldReturnEmpty()
    {
        ...
        // Act
        var result = testee.TryExtract(new ExtractInput(""));
